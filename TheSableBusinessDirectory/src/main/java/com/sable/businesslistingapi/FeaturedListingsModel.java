...
public class FeaturedListingsModel extends ArrayList<Parcelable> implements Parcelable {
    ...
    public FeaturedListingsModel(int imageType,
                                 Integer id,
                                 String title,
                                 String link,
                                 String category,
    ...
    public FeaturedListingsModel(Parcel parcel){
    ...
    public static final Creator<FeaturedListingsModel> CREATOR = new Creator<FeaturedListingsModel>(){

        @Override
        public FeaturedListingsModel createFromParcel(Parcel parcel) {
            return new FeaturedListingsModel(parcel);
        }

        @Override
        public FeaturedListingsModel[] newArray(int size) {
            return new FeaturedListingsModel[0];
        }
    };
